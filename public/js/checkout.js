...
var stripe = Stripe(
	"pk_test_51Hu5ZkFrWlSKkrTbvhqPBNWIIfkCP5OoedGYZedAJsy2eqduBxdXFHh5UQL0L1IeGKXmrmOiWJX0965jii6jdXQr006Pfc8Dh1"
);
...
if (popupForms) {
	...
	for (let form of popupForms) {
		...
		function bookClicked(event) {
			...
			btn.querySelector(".load-arrow").style.maxHeight = `${
				btn.offsetHeight - 20
			}px`;
